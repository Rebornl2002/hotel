    ...
    const handleUpdateData = () => {
        axios
            .post('http://localhost:4000/login', {
                surName: formData.firstName.value,
                name: formData.lastName.value,
                ...
                render={() => (
                    <div className={cx('tippy__pop--up__wrapper')}>
                        <div className={cx('tippy__pop--up__content')}>
                            ...
                            <div className={cx('tippy__pop--up__content__text')}>Chào mừng bạn đến với MKTHM Hotel</div>
                            <img className={cx('tippy__pop--up__content__img')} src={images.logo} alt="img" />
