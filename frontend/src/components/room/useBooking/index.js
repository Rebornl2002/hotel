...
import { handleGetFormatTimeForm2 } from '../../../utils/time';
        ...
        if (isFormValid) {
            ...
            axios
                .post('http://localhost:4000/order', {
                    ...
                    phone: orderObj.user.phoneNumber,
                    address: orderObj.user.address,
                    roomName: orderObj.room.roomName,
                    roomType: orderObj.room.roomType,
                    price: orderObj.price,
                    dayFrom: handleGetFormatTimeForm2(orderObj.orderTime.from),
                    dayTo: handleGetFormatTimeForm2(orderObj.orderTime.to),
                })
